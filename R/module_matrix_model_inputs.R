module_matrix_model_inputs_ui <- function(id) {
  ...
  tagList(
    ...
    fluidRow(
      column(
        ...
        numericInput(
          ns("Nstage"),
          label = "Nstage (# Stages)",
          value = life_stages$Value[life_stages$Name == "Nstage"]
        )
      ),
      column(
        width = 6,
    ...
    div(
      ...
      textOutput(ns("upload_error_msg_vitals"))
    ),
    ...
    tabsetPanel(
      ...
      tabPanel(
        ...
        fluidRow(
          column(
            width = 4,
            numericInput(ns("SE"), label = "SE (Egg Survival)", 
                         value = life_stages$Value[life_stages$Name == "SE"])
          ),
          column(
            width = 4,
            numericInput(ns("S0"), label = "S0 (YOY Survival)", 
                         value = life_stages$Value[life_stages$Name == "S0"])
          ),
          column(
            width = 4,
            numericInput(ns("surv_1"), label = "surv_1 (Stage 1 Survival)", 
                         value = life_stages$Value[life_stages$Name == "surv_1"])
          )
        ),
        fluidRow(
          column(
            width = 4,
            numericInput(ns("surv_2"), label = "surv_2 (Stage 2 Survival)", 
                         value = life_stages$Value[life_stages$Name == "surv_2"])
          ),
          column(
            width = 4,
            numericInput(ns("surv_3"), label = "surv_3 (Stage 3 Survival)", 
                         value = life_stages$Value[life_stages$Name == "surv_3"])
          ),
          column(
            width = 4,
            numericInput(ns("surv_4"), label = "surv_4 (Stage 4 Survival)", 
                         value = life_stages$Value[life_stages$Name == "surv_4"])
          )
        ),
        fluidRow(
          column(
            width = 4,
            numericInput(ns("surv_5"), label = "surv_5 (Stage 5 Survival)", 
                         value = life_stages$Value[life_stages$Name == "surv_5"])
          ),
          column(
            width = 4,
            numericInput(ns("surv_6"), label = "surv_6 (Stage 6 Survival)", 
                         value = life_stages$Value[life_stages$Name == "surv_6"])
          ),
          column(
            width = 4,
            numericInput(ns("surv_7"), label = "surv_7 (Stage 7 Survival)", 
                         value = life_stages$Value[life_stages$Name == "surv_7"])
          )
        ),
        fluidRow(
          column(
            width = 4,
            numericInput(ns("surv_8"), label = "surv_8 (Stage 8 Survival)", 
                         value = life_stages$Value[life_stages$Name == "surv_8"])
          ),
          column(
            width = 4,
            numericInput(ns("surv_9"), label = "surv_9 (Stage 9 Survival)", 
                         value = life_stages$Value[life_stages$Name == "surv_9"])
          ),
          column(
            width = 4,
            numericInput(ns("surv_10"), label = "surv_10 (Stage 10 Survival)", 
                         value = life_stages$Value[life_stages$Name == "surv_10"])
          )
        ),
        ...
        fluidRow(
          column(
            width = 3,
            numericInput(ns("smig_1"), label = "smig_1 (Mig. Surv. Age-1)", 
                         value = life_stages$Value[life_stages$Name == "smig_1"])
          ),
          column(
            width = 3,
            numericInput(ns("smig_2"), label = "smig_2 (Mig. Surv. Age-2)", 
                         value = life_stages$Value[life_stages$Name == "smig_2"])
          ),
          column(
            width = 3,
            numericInput(ns("smig_3"), label = "smig_3 (Mig. Surv. Age-3)", 
                         value = life_stages$Value[life_stages$Name == "smig_3"])
          ),
          column(
            width = 3,
            numericInput(ns("smig_4"), label = "smig_4 (Mig. Surv. Age-4)", 
                         value = life_stages$Value[life_stages$Name == "smig_4"])
          )
        ),
        fluidRow(
          column(
            width = 3,
            numericInput(ns("smig_5"), label = "smig_5 (Mig. Surv. Age-5)", 
                         value = life_stages$Value[life_stages$Name == "smig_5"])
          ),
          column(
            width = 3,
            numericInput(ns("smig_6"), label = "smig_6 (Mig. Surv. Age-6)", 
                         value = life_stages$Value[life_stages$Name == "smig_6"])
          ),
          column(
            width = 3,
            numericInput(ns("smig_7"), label = "smig_7 (Mig. Surv. Age-7)", 
                         value = life_stages$Value[life_stages$Name == "smig_7"])
          ),
          column(
            width = 3,
            numericInput(ns("smig_8"), label = "smig_8 (Mig. Surv. Age-8)", 
                         value = life_stages$Value[life_stages$Name == "smig_8"])
          )
        ),
        fluidRow(
          column(
            width = 3,
            numericInput(ns("smig_9"), label = "smig_9 (Mig. Surv. Age-9)", 
                         value = life_stages$Value[life_stages$Name == "smig_9"])
          ),
          column(
            width = 3,
            numericInput(ns("smig_10"), label = "smig_10 (Mig. Surv. Age-10)", 
                         value = life_stages$Value[life_stages$Name == "smig_10"])
          )
        ),
        ...
        fluidRow(
          column(
            width = 3,
            numericInput(ns("u_1"), label = "u_1 (Pre. Spwn. Surv. Age-1)", 
                         value = life_stages$Value[life_stages$Name == "u_1"])
          ),
          column(
            width = 3,
            numericInput(ns("u_2"), label = "u_2 (Pre. Spwn. Surv. Age-2)", 
                         value = life_stages$Value[life_stages$Name == "u_2"])
          ),
          column(
            width = 3,
            numericInput(ns("u_3"), label = "u_3 (Pre. Spwn. Surv. Age-3)", 
                         value = life_stages$Value[life_stages$Name == "u_3"])
          ),
          column(
            width = 3,
            numericInput(ns("u_4"), label = "u_4 (Pre. Spwn. Surv. Age-4)", 
                         value = life_stages$Value[life_stages$Name == "u_4"])
          )
        ),
        fluidRow(
          column(
            width = 3,
            numericInput(ns("u_5"), label = "u_5 (Pre. Spwn. Surv. Age-5)", 
                         value = life_stages$Value[life_stages$Name == "u_5"])
          ),
          column(
            width = 3,
            numericInput(ns("u_6"), label = "u_6 (Pre. Spwn. Surv. Age-6)", 
                         value = life_stages$Value[life_stages$Name == "u_6"])
          ),
          column(
            width = 3,
            numericInput(ns("u_7"), label = "u_7 (Pre. Spwn. Surv. Age-7)", 
                         value = life_stages$Value[life_stages$Name == "u_7"])
          ),
          column(
            width = 3,
            numericInput(ns("u_8"), label = "u_8 (Pre. Spwn. Surv. Age-8)", 
                         value = life_stages$Value[life_stages$Name == "u_8"])
          )
        ),
        fluidRow(
          column(
            width = 3,
            numericInput(ns("u_9"), label = "u_9 (Pre. Spwn. Surv. Age-9)", 
                         value = life_stages$Value[life_stages$Name == "u_9"])
          ),
          column(
            width = 3,
            numericInput(ns("u_10"), label = "u_10 (Pre. Spwn. Surv. Age-10)", 
                         value = life_stages$Value[life_stages$Name == "u_10"])
          )
        ),
        ...
        fluidRow(
          column(
            width = 4,
            numericInput(ns("M.cv"), 
                         label = "M.cv (Coefficient of variation in stage-specific mortality)", 
                         value = life_stages$Value[life_stages$Name == "M.cv"])
          ),
          column(
            width = 4,
            numericInput(ns("M.rho"), 
                         label = "M.rho (Correlation in mortality through time)", 
                         value = life_stages$Value[life_stages$Name == "M.rho"])
          ),
          column(
            width = 4,
            numericInput(ns("p.cat"), 
                         label = "p.cat (Probability of catastrophic event per generation)", 
                         value = life_stages$Value[life_stages$Name == "p.cat"])
          )
        ),
        tags$h5("Sex Ratio"),
        fluidRow(
          column(
            width = 6,
            numericInput(ns("SR"), 
                         label = "SR - Sex ratio (portion female at birth)", 
                         value = life_stages$Value[life_stages$Name == "SR"])
          )
        )
      ...
      tabPanel(
        ...
        fluidRow(
          column(
            width = 3,
            numericInput(ns("year_1"), label = "year_1 (Years as Stage 1)", 
                         value = life_stages$Value[life_stages$Name == "year_1"])
          ),
          column(
            width = 3,
            numericInput(ns("year_2"), label = "year_2 (Years as Stage 2)", 
                         value = life_stages$Value[life_stages$Name == "year_2"])
          ),
          column(
            width = 3,
            numericInput(ns("year_3"), label = "year_3 (Years as Stage 3)", 
                         value = life_stages$Value[life_stages$Name == "year_3"])
          ),
          column(
            width = 3,
            numericInput(ns("year_4"), label = "year_4 (Years as Stage 4)", 
                         value = life_stages$Value[life_stages$Name == "year_4"])
          )
        ),
        fluidRow(
          column(
            width = 3,
            numericInput(ns("year_5"), label = "year_5 (Years as Stage 5)", 
                         value = life_stages$Value[life_stages$Name == "year_5"])
          ),
          column(
            width = 3,
            numericInput(ns("year_6"), label = "year_6 (Years as Stage 6)", 
                         value = life_stages$Value[life_stages$Name == "year_6"])
          ),
          column(
            width = 3,
            numericInput(ns("year_7"), label = "year_7 (Years as Stage 7)", 
                         value = life_stages$Value[life_stages$Name == "year_7"])
          ),
          column(
            width = 3,
            numericInput(ns("year_8"), label = "year_8 (Years as Stage 8)", 
                         value = life_stages$Value[life_stages$Name == "year_8"])
          )
        ),
        fluidRow(
          column(
            width = 3,
            numericInput(ns("year_9"), label = "year_9 (Years as Stage 9)", 
                         value = life_stages$Value[life_stages$Name == "year_9"])
          ),
          column(
            width = 3,
            numericInput(ns("year_10"), label = "year_10 (Years as Stage 10)", 
                         value = life_stages$Value[life_stages$Name == "year_10"])
          )
        )
      ...
      tabPanel(
        ...
        fluidRow(
          column(
            width = 4,
            numericInput(ns("events"), label = "events (Spawn Events per Female)", 
                         value = life_stages$Value[life_stages$Name == "events"])
          ),
          column(
            width = 4,
            numericInput(ns("eps_sd"), label = "eps_sd (SD variation in Eggs per Female)", 
                         value = life_stages$Value[life_stages$Name == "eps_sd"])
          )
        ),
        tags$p(
        ...
        fluidRow(
          column(
            width = 3,
            numericInput(ns("eps_1"), label = "eps_1 (Stage 1)", 
                         value = life_stages$Value[life_stages$Name == "eps_1"])
          ),
          column(
            width = 3,
            numericInput(ns("eps_2"), label = "eps_2 (Stage 2)", 
                         value = life_stages$Value[life_stages$Name == "eps_2"])
          ),
          column(
            width = 3,
            numericInput(ns("eps_3"), label = "eps_3 (Stage 3)", 
                         value = life_stages$Value[life_stages$Name == "eps_3"])
          ),
          column(
            width = 3,
            numericInput(ns("eps_4"), label = "eps_4 (Stage 4)", 
                         value = life_stages$Value[life_stages$Name == "eps_4"])
          )
        ),
        fluidRow(
          column(
            width = 3,
            numericInput(ns("eps_5"), label = "eps_5 (Stage 5)", 
                         value = life_stages$Value[life_stages$Name == "eps_5"])
          ),
          column(
            width = 3,
            numericInput(ns("eps_6"), label = "eps_6 (Stage 6)", 
                         value = life_stages$Value[life_stages$Name == "eps_6"])
          ),
          column(
            width = 3,
            numericInput(ns("eps_7"), label = "eps_7 (Stage 7)", 
                         value = life_stages$Value[life_stages$Name == "eps_7"])
          ),
          column(
            width = 3,
            numericInput(ns("eps_8"), label = "eps_8 (Stage 8)", 
                         value = life_stages$Value[life_stages$Name == "eps_8"])
          )
        ),
        fluidRow(
          column(
            width = 3,
            numericInput(ns("eps_9"), label = "eps_9 (Stage 9)", 
                         value = life_stages$Value[life_stages$Name == "eps_9"])
          ),
          column(
            width = 3,
            numericInput(ns("eps_10"), label = "eps_10 (Stage 10)", 
                         value = life_stages$Value[life_stages$Name == "eps_10"])
          )
        ),
        tags$p(
        ...
        fluidRow(
          column(
            width = 6,
            numericInput(ns("egg_rho"), label = "egg_rho (Correlation in egg fecundity through time)", 
                         value = life_stages$Value[life_stages$Name == "egg_rho"])
          ),
          column(
            width = 6,
            numericInput(ns("int"), label = "int (Spawning Interval - years)", 
                         value = life_stages$Value[life_stages$Name == "int"])
          )
        ),
        tags$p(
        ...
        fluidRow(
          column(
            width = 3,
            numericInput(ns("mat_1"), label = "mat_1 (Maturity as Stage 1)", 
                         value = life_stages$Value[life_stages$Name == "mat_1"])
          ),
          column(
            width = 3,
            numericInput(ns("mat_2"), label = "mat_2 (Maturity as Stage 2)", 
                         value = life_stages$Value[life_stages$Name == "mat_2"])
          ),
          column(
            width = 3,
            numericInput(ns("mat_3"), label = "mat_3 (Maturity as Stage 3)", 
                         value = life_stages$Value[life_stages$Name == "mat_3"])
          ),
          column(
            width = 3,
            numericInput(ns("mat_4"), label = "mat_4 (Maturity as Stage 4)", 
                         value = life_stages$Value[life_stages$Name == "mat_4"])
          )
        ),
        fluidRow(
          column(
            width = 3,
            numericInput(ns("mat_5"), label = "mat_5 (Maturity as Stage 5)", 
                         value = life_stages$Value[life_stages$Name == "mat_5"])
          ),
          column(
            width = 3,
            numericInput(ns("mat_6"), label = "mat_6 (Maturity as Stage 6)", 
                         value = life_stages$Value[life_stages$Name == "mat_6"])
          ),
          column(
            width = 3,
            numericInput(ns("mat_7"), label = "mat_7 (Maturity as Stage 7)", 
                         value = life_stages$Value[life_stages$Name == "mat_7"])
          ),
          column(
            width = 3,
            numericInput(ns("mat_8"), label = "mat_8 (Maturity as Stage 8)", 
                         value = life_stages$Value[life_stages$Name == "mat_8"])
          )
        ),
        fluidRow(
          column(
            width = 3,
            numericInput(ns("mat_9"), label = "mat_9 (Maturity as Stage 9)", 
                         value = life_stages$Value[life_stages$Name == "mat_9"])
          ),
          column(
            width = 3,
            numericInput(ns("mat_10"), label = "mat_10 (Maturity as Stage 10)", 
                         value = life_stages$Value[life_stages$Name == "mat_10"])
          )
        )
      ...
      tabPanel(
        ...
        fluidRow(
          column(
            width = 12,
            numericInput(ns("k"), label = "(K) - Adult Carrying Capacity (for compensation ratios)", 
                         value = life_stages$Value[life_stages$Name == "k"])
          )
        ),
        ...
        fluidRow(
          column(
            width = 4,
            numericInput(ns("cr_E"), label = "cr_E (Egg Survival CR)", 
                         value = life_stages$Value[life_stages$Name == "cr_E"])
          ),
          column(
            width = 4,
            numericInput(ns("cr_0"), label = "cr_0 (Stage 0 Survival CR)", 
                         value = life_stages$Value[life_stages$Name == "cr_0"])
          ),
          column(
            width = 4,
            numericInput(ns("cr_1"), label = "cr_1 (Stage 1 Survival CR)", 
                         value = life_stages$Value[life_stages$Name == "cr_1"])
          )
        ),
        fluidRow(
          column(
            width = 4,
            numericInput(ns("cr_2"), label = "cr_2 (Stage 2 Survival CR)", 
                         value = life_stages$Value[life_stages$Name == "cr_2"])
          ),
          column(
            width = 4,
            numericInput(ns("cr_3"), label = "cr_3 (Stage 3 Survival CR)", 
                         value = life_stages$Value[life_stages$Name == "cr_3"])
          ),
          column(
            width = 4,
            numericInput(ns("cr_4"), label = "cr_4 (Stage 4 Survival CR)", 
                         value = life_stages$Value[life_stages$Name == "cr_4"])
          )
        ),
        fluidRow(
          column(
            width = 4,
            numericInput(ns("cr_5"), label = "cr_5 (Stage 5 Survival CR)", 
                         value = life_stages$Value[life_stages$Name == "cr_5"])
          ),
          column(
            width = 4,
            numericInput(ns("cr_6"), label = "cr_6 (Stage 6 Survival CR)", 
                         value = life_stages$Value[life_stages$Name == "cr_6"])
          ),
          column(
            width = 4,
            numericInput(ns("cr_7"), label = "cr_7 (Stage 7 Survival CR)", 
                         value = life_stages$Value[life_stages$Name == "cr_7"])
          )
        ),
        fluidRow(
          column(
            width = 4,
            numericInput(ns("cr_8"), label = "cr_8 (Stage 8 Survival CR)", 
                         value = life_stages$Value[life_stages$Name == "cr_8"])
          ),
          column(
            width = 4,
            numericInput(ns("cr_9"), label = "cr_9 (Stage 9 Survival CR)", 
                         value = life_stages$Value[life_stages$Name == "cr_9"])
          ),
          column(
            width = 4,
            numericInput(ns("cr_10"), label = "cr_10 (Stage 10 Survival CR)", 
                         value = life_stages$Value[life_stages$Name == "cr_10"])
          )
        )
      ...
      tabPanel(
        "All Inputs",
        module_matrix_life_cycle_params_ui(ns("module_matrix_life_cycle_params"))
      )
...
module_matrix_model_inputs_server <- function(id) {
  moduleServer(id,
               function(input, output, session) {
                 ...
                 anadromous_reactive <- reactive({ input$anadromous })
                 Nstage_reactive <- reactive({ input$Nstage })
